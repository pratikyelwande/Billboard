import { useState, useEffect, useRef, ChangeEvent, FormEvent } from 'react';
                         ...
                         export const Dashboard = () => {
                             ...
                             const [formData, setFormData] = useState<BillboardFormData>({
                                 ...
                                 available: 'Yes',
                                 amenities: '',
                                 bImg: [], // Initialize as an empty array
                                 bReview: '',
                                 bDescription: '',
                             });
                             ...
                             const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
                                 if (e.target.files) {
                                     setFormData(prev => ({
                                         ...prev,
                                         bImg: Array.from(e.target.files) // Convert FileList to array
                                     }));
                                 }
                             };
                             ...
                             const handleSubmit = async (e: FormEvent) => {
                                 ...
                                 try {
                                     ...
                                     if (formData.bImg.length > 0) {
                                         const formDataWithFile = new FormData();
                                         formData.bImg.forEach((file, index) => {
                                             formDataWithFile.append(`bImg${index}`, file);
                                         });
