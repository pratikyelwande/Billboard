        ...
        <StyledWrapper>
            <form className="form_container" onSubmit={handleSubmit}>
                ...
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className="input_field" id="email_field" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                <div className="input_container">
...
const StyledWrapper = styled.div`
    ...
    align-items: center;
    height: 100vh;
    background: linear-gradient(43deg, #4158D0, #C850C0 46%, #FFCC70);
